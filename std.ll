; ModuleID = './tests/std.c'
source_filename = "./tests/std.c"
...
define dso_local float @getfloat() #0 {
  ...
  %2 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i64 0, i64 0), float* noundef %1)
...
10:                                               ; preds = %6
  ...
  %15 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i64 0, i64 0), float* noundef %14)
  br label %16
...
define dso_local void @putfloat(float noundef %0) #0 {
  ...
  %5 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i64 0, i64 0), double noundef %4)
  ret void
}
